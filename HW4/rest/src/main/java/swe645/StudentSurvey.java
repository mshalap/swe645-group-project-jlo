...
public class StudentSurvey{
	...
	public List<Survey> get() {
		...
		consumerProps.put("ssl.truststore.location", "/usr/local/tomcat/webapps/HW3/WEB-INF/classes/keys/user-truststore.jks");
		...
		consumerProps.put("ssl.keystore.location", "/usr/local/tomcat/webapps/HW3/WEB-INF/classes/keys/user-keystore.jks");
	...
	public Response postdata(Survey s){
		try {
			...
			producerProps.put("ssl.truststore.location", "/usr/local/tomcat/webapps/HW3/WEB-INF/classes/keys/user-truststore.jks");
			...
			producerProps.put("ssl.keystore.location", "/usr/local/tomcat/webapps/HW3/WEB-INF/classes/keys/user-keystore.jks");
