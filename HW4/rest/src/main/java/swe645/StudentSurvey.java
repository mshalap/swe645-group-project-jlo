...
public class StudentSurvey{
	...
	public List<Survey> get() {
		...
		consumerProps.put("ssl.truststore.location", "/WEB-INF/keys/user-truststore.jks");
		...
		consumerProps.put("ssl.keystore.location", "/WEB-INF/keys/user-keystore.jks");
	...
	public Response postdata(Survey s){
		try {
			...
			producerProps.put("ssl.truststore.location", "/WEB-INF/keys/user-truststore.jks");
			...
			producerProps.put("ssl.keystore.location", "/WEB-INF/keys/user-keystore.jks");
